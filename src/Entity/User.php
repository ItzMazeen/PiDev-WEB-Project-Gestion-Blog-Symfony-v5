...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\OneToMany(mappedBy: 'doctor', targetEntity: Ficheconsultation::class)]
    ...
    public function setDossierMedical(?DossierMedical $dossierMedical): self
    {
        ...
        if ($dossierMedical === null && $this->dossierMedical !== null) {
            $this->dossierMedical->setUserId(null);
        }

        // set the owning side of the relation if necessary
        if ($dossierMedical !== null && $dossierMedical->getUserId() !== $this) {
            $dossierMedical->setUserId($this);
        }
    ...
    public function addFicheconsultation(Ficheconsultation $ficheconsultation): self
    {
        if (!$this->ficheconsultations->contains($ficheconsultation)) {
            ...
            $ficheconsultation->setDoctor($this);
        }
    ...
    public function removeFicheconsultation(Ficheconsultation $ficheconsultation): self
    {
        if ($this->ficheconsultations->removeElement($ficheconsultation)) {
            // set the owning side to null (unless already changed)
            if ($ficheconsultation->getDoctor() === $this) {
                $ficheconsultation->setDoctor(null);
            }
        }
